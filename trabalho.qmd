...
A partir da matriz de espalhamento, observa-se que as variáveis mais correlacionadas são platelet_count e wbc_count (corr ≈ 0.749), indicando uma forte relação positiva.

Também há correlação moderada entre platelet_count e platelet_distribution_width (corr ≈ 0.456) e entre wbc_count e platelet_distribution_width (corr ≈ 0.350).

Em relação à variável alvo, observa-se correlação negativa com platelet_count (corr ≈ -0.577) e platelet_distribution_width (corr ≈ -0.651).
